...
@section('content')
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-6 overflow-auto" style="padding-bottom: 100px">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Add New Demande</h1>
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Fill out the form below to create a new internship demand.</p>
            </div>
