...
@section('content')
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-6 overflow-auto" style="padding-bottom: 100px">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Mettre à jour la demande de <span class="text-blue-800">{{ $demande->person->fullname }}</span></h1>
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Remplissez le formulaire ci-dessous pour mettre à jour la demande de stage.</p>
            </div>
            <!-- Form Container -->
                ...
                <form action="{{ route('updateDemande', $demande->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="px-6 py-8 sm:px-8">
                        <div class="mb-6">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Informations de base sur le candidat et son parcours académique.</p>
                        </div>
