...
<body class="font-sans antialiased bg-gray-100 dark:bg-gray-900">
    ...
    <script>
        ...
        function fillDemoCredentials() {
            ...
            demoButton.innerHTML = '<svg class="w-4 h-4 mr-2 animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg>chargement...';
                ...
                typeText(emailInput, 'hamza@g.com', () => {
                    setTimeout(() => {
                        typeText(passwordInput, '12345678', () => {
                            ...
                            demoButton.innerHTML = '<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Démo Credentials Loaded';
                            
                            // Change button back after 2 seconds
                            setTimeout(() => {
                                demoButton.innerHTML = '<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>Utiliser les informations d\'identification';
                            }, 2000);
                        });
                    }, 500);
                });
