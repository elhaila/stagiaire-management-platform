    ...
    <div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center space-x-3">
                ...
                <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Modifier les informations personnelles d' <span class="text-indigo-600 dark:text-indigo-400">{{ $person->fullname }}</span></h1>
            </div>
        </div>
        ...
        <form action="{{ route('updatePerson', $person->id) }}" method="POST">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- Full Name --}}
                    <div>
                        <label for="fullname" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nom complet</label>
